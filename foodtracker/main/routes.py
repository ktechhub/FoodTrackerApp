...
def index():
    ...
    return render_template('index.html', title=title, log_dates=log_dates)
...
def add():
    ...
    return render_template('add.html', title=title, foods=foods, food=None)
...
def view(log_id):
    ...
    return render_template('view.html', title=title, foods=foods, log=log, totals=totals)
